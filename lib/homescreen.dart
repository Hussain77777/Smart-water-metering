...
class _HomeState extends State<Home> {
 ...
 double totalWaterConsumed=0,CC=0  , h0=0,h1=0,h2=0,h3=0,h4=0,h5=0,h6=0,h7=0,h8=0,h9=0,
  ...
  void Cu(){
    ...
    child("R1")
        .
    once().then((value) {
      CC = value.value["Current Flow Rate1"];
      ...
      Navigator.of(context).push(MaterialPageRoute(
          builder: (BuildContext context) =>Currentflow(
            C0:CC.toString(),
  ...
  void updateMonthly(){
    _databaseReference
        ...
        .
    once().then((value) {
      d0 = value.value["21-6-21"];
      d1 = value.value["22-6-21"];
      d2 = value.value["23-6-21"];
      d3 = value.value["24-6-21"];
      d4 = value.value["25-6-21"];
      d5 = value.value["26-6-21"];
      d6 = value.value["27-6-21"];
      d7 = value.value["28-6-21"];
      d8 = value.value["29-6-21"];
      d9 = value.value["30-6-21"];
      d10 = value.value["June Monthly Usage"];
